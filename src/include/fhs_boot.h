...
#define FHS_BOOT_STATE  "fhs.boot"
#define FHS_BOOT_NAME   "boot"
#define FHS_BOOT_ROOT   FHS_DATA_ROOT "/boot"

/* Subdirectories, kept out of the top level so the kernels stay prominent. */
#define FHS_BOOT_KERNELS      "kernels"
#define FHS_BOOT_EFI          "efi"
#define FHS_BOOT_COLLECTIONS  "kernelcollections"

struct fhs_boot_status {
	bool enabled;
	bool reboot_pending;
 ...
 */
bool fhs_boot_running_kernel(char *path, size_t path_len,
